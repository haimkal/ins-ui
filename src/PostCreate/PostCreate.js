...
import { getCroppedImg } from '../EditProfile/imageCropper';
...
export default function PostCreate() {
    ...
    async function submit(values) {
        const imageFile = await getCroppedImg(image, crop, 'postCroppedImage.jpg');
    ...
    return (
        <div className="PostCreate d-flex row">
                        ...
                        <Form className="PostCreate__form mt-5 mx-4 col-lg-10 px-0" noValidate>
                            ...
                            <div class="form-group my-3">
                                ...
                                <Field as="select" className="form-control" name="whereItIsNow" id="whereItIsNow">
                                    <option key="empty" value="" disabled>Select who currently took the dress</option>
                            ...
                            <div className="form-group my-3">
                                ...
                                <Field as="select" className="form-control" name="size" id="size">
                                    <option key="empty" value="" disabled>Select dress size</option>
